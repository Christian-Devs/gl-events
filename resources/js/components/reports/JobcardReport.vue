    ...
    <div class="container py-4">
        <div class="row mb-3">
            <div class="col">
                ...
                <h2 class="mb-4">Jobcards Report</h2>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="card shadow-sm text-center p-3">
                    ...
                    <p class="h4">{{ summary.total_jobcards }}</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm text-center p-3">
                    <h5>Open</h5>
                    <p class="h4 text-warning">{{ summary.open }}</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm text-center p-3">
                    <h5>In Progress</h5>
                    <p class="h4 text-info">{{ summary.in_progress }}</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm text-center p-3">
                    <h5>Completed</h5>
                    <p class="h4 text-success">{{ summary.completed }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0">Monthly Jobcard Activity (Last 12 Months)</h5>
            </div>
            <div class="card-body">
...
export default {
    ...
    created() {
        axios.get('/api/reports/jobcards')
            .then(res => {
